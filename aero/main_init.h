...
#define RS		2		// Номер пина RS
#define E		3		// Номер пина Е
...
//	необходимо включить потдержку записав TRUE в ниже записаный
...
//-------------------------------------------------------------------------
//  Параметры необходимые для работы с SPI в режиме Slave
//
// S_OUT необходим для оповещение Мастера о готовности Слейва передавать данные
//-------------------------------------------------------------------------

#define DDR_S_OUT	DDRB	// Порт на котором будет S_OUT
#define PORT_S_OUT	PORTB	// Порт на котором будет S_OUT
#define S_OUT		0		// Номер пина для S_OUT
...
#define PORT_W		B		// Порт для 1-wire задается буквой порта A, B, C, D.
